...
func configureFlags(api *operations.InterviewChallengeAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.InterviewChallengeAPI) http.Handler {
	...
	if api.ToolsLookupDomainHandler == nil {
		api.ToolsLookupDomainHandler = tools.LookupDomainHandlerFunc(func(params tools.LookupDomainParams) middleware.Responder {
			return middleware.NotImplemented("operation tools.LookupDomain has not yet been implemented")
		})
	}
	if api.HistoryQueriesHistoryHandler == nil {
		api.HistoryQueriesHistoryHandler = history.QueriesHistoryHandlerFunc(func(params history.QueriesHistoryParams) middleware.Responder {
			return middleware.NotImplemented("operation history.QueriesHistory has not yet been implemented")
		})
	}
	if api.ToolsValidateIPHandler == nil {
